...
const translations = {
  ...
  ku: {
    logo: "یارا ستۆر",
    nav: { home: "ماڵەوە", shop: "دوکان", contact: "پەیوەندیمان پێوە" },
    home: { title: "شێوەی خۆت دیاری بکە", shopBtn: "کڕین" },
    features: [
      { title: "ناردنی خێرا", desc: "جڵاوانەکانت بە خێرایی و بەکاتی خۆیان دەگەیەنرێن" },
      { title: "پشتیوانی 24/7", desc: "پرسیار هەیە؟ تیمی پشتیوانی هەموو کات ئەستە" },
      { title: "گەڕاندنەوەی ئاسان", desc: "ئەگەر نەدەرست بوو، گەڕێنەوە — ئاسان و خێرا" }
    ],
